...
CREATE TABLE public.orders_1 (
    ...
    price integer,
    CONSTRAINT orders_1_unique UNIQUE (title)
);
...
CREATE TABLE public.orders_2 (
    ...
    CONSTRAINT orders_2_unique UNIQUE (title)
);
...
ALTER SEQUENCE public.orders_id_seq OWNED BY public.orders_2.id;
...
--
-- Name: orders_2 orders_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
