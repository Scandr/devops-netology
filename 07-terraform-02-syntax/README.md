...
data.yandex_compute_image.last_ubuntu: Read complete after 1s [id=fd8emvfmfoaordspe1jr]
...
yelena@DESKTOP-T14F2UM:~/devops-netology/terraform$ terraform validate
Success! The configuration is valid.

yelena@DESKTOP-T14F2UM:~/devops-netology/terraform$ terraform plan
data.yandex_compute_image.last_ubuntu: Reading...
data.yandex_compute_image.last_ubuntu: Read complete after 8s [id=fd8emvfmfoaordspe1jr]
